    ...
    <nav class="navbar navbar-default" role="navigation">  
      <div class="container">
        <div class="navbar-header">
          ...
          <!-- LOGO -->              
          <!-- TEXT BASED LOGO -->
          <a class="navbar-brand" href="index"><i class="fa fa-university"></i><span>Varsity</span></a>
          <!-- IMG BASED LOGO  -->
                  ...
                  <div class="mu-related-item-area">
                    <div id="mu-related-item-slide">
                      <div class="col-md-6">
                        <div class="mu-latest-course-single">
                          <figure class="mu-latest-course-img">
                            <a href="#"><img alt="img" src="<c:url value = "file/assets/img/courses/1.jpg"/>"></a>
                            <figcaption class="mu-latest-course-imgcaption">
                              <a href="#">Drawing</a>
                              <span><i class="fa fa-clock-o"></i>90Days</span>
                            </figcaption>
                      ...
                      <div class="col-md-6">
                        <div class="mu-latest-course-single">
                          <figure class="mu-latest-course-img">
                            <a href="#"><img alt="img" src="<c:url value = "file/assets/img/courses/2.jpg"/>"></a>
                            <figcaption class="mu-latest-course-imgcaption">
                              <a href="#">Drawing</a>
                              <span><i class="fa fa-clock-o"></i>90Days</span>
                            </figcaption>
                    ...
                    <div class="mu-sidebar-popular-courses">
                      <div class="media">
                        <div class="media-left">
                          <a href="#">
                            <img class="media-object" src="<c:url value = "file/assets/img/courses/1.jpg"/>" alt="img">
                          </a>
                        </div>
                      ...
                      <div class="media">
                        <div class="media-left">
                          <a href="#">
                            <img class="media-object" src="<c:url value = "file/assets/img/courses/2.jpg"/>" alt="img">
                          </a>
                        </div>
                        <div class="media-body">
                      ...
                      <div class="media">
                        <div class="media-left">
                          <a href="#">
                            <img class="media-object" src="<c:url value = "file/assets/img/courses/3.jpg"/>" alt="img">
                          </a>
                        </div>
                        <div class="media-body">
