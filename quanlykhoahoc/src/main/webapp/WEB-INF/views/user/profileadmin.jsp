  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="<c:url value = "indexadmin"/>">
        ...
        <div class="sidebar-brand-text mx-3">IT-BK <sup>Admin</sup></div>
      </a>
        ...
        <div class="row">
          ...
          <div class="col-lg-6" >
            <div class="p-5">
              ...
              <form class="user" style="margin-left: 250px">
              
	              	<div class="form-group row">
	                      <h3><b>${admin.getName()}<b></h3>
	                </div>
		            <div class="form-group row">
		                   <label >Gmail <span >: </span></label><p>${admin.getEmail()}</p>
		            </div>
