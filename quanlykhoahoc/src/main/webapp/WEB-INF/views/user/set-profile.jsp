  ...
  <div class="mu-contact-content" >           
    <div class="row">
      <div class="col-md-12" style="padding-top: 60px; padding-left: 350px">
        <div class="mu-contact-left"  style="margin-left: 150px">
        <h2>Thay đổi Thông tin cá nhân</h2>
          <form class="contactform" name = "set-profile">                  
            <p class="comment-form-email">
              <p></p>
              <p><i> Họ tên: </i></p>
              <input type="text"  size="50" value="${sinhvien.getHoten()}" name="hoten" id="hoten">
            </p>
            <p class="comment-form-url">
              <p></p>
              <p><i> Số Điện Thoại: </i></p>
              <input type="text" size="50" name="sdt" id="sdt"  value="${sinhvien.getSdt()}">  
            </p>
            <p class="comment-form-url">
              <p></p>
              
              <p><i> Địa Chỉ: </i></p>
              <input type="text" size="50" name="diachi" id="diachi" value="${sinhvien.getDiachi()}" >  
            </p>
            <p class="comment-form-url" style="margin-top: 30px">
             	
              <input type="button" value="Submit"  name="submit" id="btn1_submit" size="50" style="width: 425px; background-color: #aad4ff">
            </p>        
          </form>
        </div>
      </div>
