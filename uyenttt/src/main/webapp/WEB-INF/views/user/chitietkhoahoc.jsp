...
<body id="page-top">
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        <a class="nav-link" href="<c:url value = "/addgiaovien"/>">
          <i class="fas fa-fw fa-chart-area"></i>
          <span>Thêm giáo viên</span></a>
      </li>

      <li class="nav-item">
        <a class="nav-link" href="<c:url value = "/addadmin"/>">
          <i class="fas fa-fw fa-chart-area"></i>
                    ...
                    <div class="col-md-12">
                      <div class="mu-latest-course-single" >
                        <figure class="mu-latest-course-img">
                          <a href="#"><img src="<c:url value = "${khoahoc.getImg()}"/>" alt="img" style="width: 800px; height: 400px"></a>
